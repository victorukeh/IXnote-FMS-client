...
const Pdf = (props) => {
  ...
  return (
    <>
      {show && message === 'PDF has been deleted' && (
        <div className='div'>
      ...
      {show && message === 'PDF updated successfully' && (
        <div className='div'>
          <Alert color='success' className='alert'>
            <strong>Success!</strong> {message}
          </Alert>
            ...
            <div className='col'>
              <Card className='bg-default shadow'>
                <CardHeader className='bg-transparent border-0'>
                  <h3 className='text-white mb-0'>PDF Files</h3>
                </CardHeader>
                <Table
                            ...
                            <UncontrolledDropdown>
                              ...
                              >
                                <DropdownItem
                                  href='#pablo'
                                  onClick={() =>
                                    setRenameOnClick(pd._id, pd.filename)
                                  }
                                >
                                  Rename
                                </DropdownItem>
