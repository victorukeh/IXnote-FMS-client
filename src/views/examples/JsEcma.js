...
const JS= (props) => {
  ...
  var sizeinMB
  let pageSize = 10
  let pagesCount = Math.ceil(js.length / pageSize)
  ...
  const reverseDate = ({ js }) => {
    let date = js.uploadDate.split('T')[0]
    return date
  }
          ...
          <div className='col'>
            <Card className='bg-default shadow'>
              <CardHeader className='bg-transparent border-0'>
                <h3 className='text-white mb-0'>All Identified JS and Ecmascript Files</h3>
              </CardHeader>
              <Table
                      ...
                      <td className='text-right'>
                        <UncontrolledDropdown>
                          ...
                          <DropdownMenu className='dropdown-menu-arrow' right>
                            ...
                            <DropdownItem
                              onClick={() => deleteFile(js._id, js.filename)}
                            >
                              Delete
                            </DropdownItem>
                            <DropdownItem
                              href={`http://localhost:2000/download/${js.filename}`}
                            >
                              Download
                            </DropdownItem>
                          </DropdownMenu>
